...
const buttonVariants = (tag: string, contentEditor: Editor, options = {}) => {
  ...
  return cn(
    isActive,
    "hover:text-white hover:bg-[#3d3d3d] bg-none text-white w-6 h-6"
  );
};
        ...
        <div className="bg-black flex gap-x-1 border border-gray-50 px-2.5 py-1.5 rounded-md relative">
          <Tooltip>
            ...
            <TooltipContent
              side="top"
              sideOffset={8}
              className="text-white bg-black py-1 px-2 rounded-sm text-sm"
            >
              <div className="flex items-center gap-x-0.5">
                <span>粗体</span>
                {platform === "mac" && (
                  <>
                    <span className="inline-flex items-center justify-center w-4 h-4 text-[10px] bg-gray-500 rounded-sm">
                      ⌘
                    </span>
                    <span className="inline-flex items-center justify-center w-4 h-4 text-[10px] bg-gray-500 rounded-sm">
                      B
