...
import type { ExportContent, ExportJSON } from "./types";
...
export function Header(props: HeaderProps) {
      ...
      reader.onload = async (e) => {
        ...
        try {
          ...
          if (importData.data && typeof importData.data === "object") {
            ...
            const contents: ContentWithId[] = exportContents.map(
              (item) => item
            );
  ...
  async function handleFileSave() {
    ...
    // get theme content
    const title = exportContents.find(
      (item) => item.type === "theme_content"
    )?.title;
    const date = new Date();
    const fullDateString = `${date
      .toLocaleDateString()
      .replace(/\//g, "-")}_${date.toLocaleTimeString().replaceAll(":", "")}`;
    const fileName = `${
      removeHtmlTags(title) || "未命名"
    }-${fullDateString}.oneimg`;
      ...
      <header className="h-[58px] flex gap-4 items-center px-4 border-b border-b-gray-200">
          ...
          <MenubarMenu>
            ...
            <MenubarContent className="max-h-[calc(100vh-150px)] overflow-y-auto">
              ...
              <MenubarItem onClick={handleImageExportDialogOpen}>
                ...
                <span>导出图片</span>
                {platform === "mac" && (
                  <MenubarShortcut>⌘+Shift+E</MenubarShortcut>
                )}
                {platform === "windows" && (
              ...
              <MenubarItem asChild className="">
                <a
                  href="https://support.qq.com/product/673291"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <MenubarItem asChild>
                <a
                  href="https://github.com/byodian/oneimg"
                  target="_blank"
                  rel="noreferrer"
                >
                  <Image
              ...
              <MenubarItem asChild>
                <a
                  href="https://www.xiaohongshu.com/user/profile/5f018150000000000101fe96"
                  target="_blank"
                  rel="noreferrer"
                >
                  <Image
                ...
                <div>
                  {themeColorMap[theme].map((color) => (
                    <Button
                      ...
                      className={cn({
                        "bg-accent": themeColor === color.label,
                      })}
                    >
                      <div
        ...
        <Dialog open={isOpenFile} onOpenChange={setIsOpenFile}>
          {dialogType === "open_file" && (
            <DialogContent className="max-w-full sm:max-w-[900px] px-10 py-8 h-full overflow-y-auto sm:h-auto">
              <DialogHeader>
              ...
              <div className="flex flex-col gap-8">
                <div className="flex items-center gap-4 p-8 bg-gray-300 rounded-lg">
                  ...
                  <Button
                    ...
                    onClick={handleOpenfileBtnClick}
                  >
                    从文件加载
                  </Button>
                </div>
                <div className="flex flex-col sm:flex-row justify-between gap-4">
                  ...
                  <div className="text-center flex flex-col gap-4 px-6 py-4">
                    ...
                    <Button
                      variant="outline"
                      size="lg"
                      onClick={handleImageExportDialogOpen}
                    >
                      导出为图片
                    </Button>
                  </div>
                ...
                <div className="flex flex-col sm:flex-row justify-between gap-4">
                  ...
                  <div className="flex items-center justify-center flex-col gap-4 px-8 py-4">
                    <div className="flex flex-grow-0 flex-shrink-0 items-center justify-center bg-warning w-[110px] h-[110px] rounded-full">
                      <Logo
                        type="part"
                        className="w-12 h-12 text-warning-foreground"
                      />
                    </div>
                    <h3 className="font-bold text-xl">OneIMG+</h3>
                    <p className="text-sm flex-grow">
          ...
          {dialogType === "reset_data" && (
            <DialogContent className="max-w-full sm:max-w-[495px] px-10 py-8 h-full overflow-y-auto sm:h-auto">
            ...
            <DialogContent className="max-w-full sm:max-w-[900px] px-10 py-8 h-full overflow-y-auto sm:h-auto">
              ...
              <div>
                <video controls autoPlay muted width="100%" height="380px">
                  <source
                    src="https://file.oneimgai.com/user-guide.mp4"
                    type="video/mp4"
                  />
